...
export default function HeroSection() {
  return (
    <>
      <section className="flex flex-col-reverse py-20 md:grid md:gap-10 gap-10 md:grid-cols-2 md:place-items-center max-w-4xl lg:max-w-5xl md:mx-auto">
    ...
    Coded by <a href="https://github.com/davidoludolapo">Dolapo O.</a>.
  </div>
    </>
  );
}
